    ...
    <lido:event>
        ...
        <lido:eventActor>
            ...
            <lido:actorInRole>
                <lido:actor>
                    <lido:nameActorSet>
                        <lido:appellationValue lido:label="firstname">#Objets | Aut./Interv. | Prénom 1#</lido:appellationValue>
                        <lido:appellationValue lido:label="lastname">#Objets | Aut./Interv. | Nom 1#</lido:appellationValue>
                    </lido:nameActorSet>
                    <lido:vitalDatesActor>
                        <lido:earliestDate>#Objets | Aut./Interv. | Dates/Siècle [type = Date de naissance without Siècle] 1#</lido:appellationValue>
                        <lido:latestDate>#Objets | Aut./Interv. | Dates/Siècle [type = Date de mort without Siècle] 1#</lido:appellationValue>
                    </lido:vitalDatesACtor>
                </lido:actor>
                <lido:roleActor>
        ...
        <lido:eventActor>
            ...
            <lido:actorInRole>
                <lido:actor>
                    ...
                    <lido:vitalDatesActor>
                        <lido:earliestDate>#Objets | Aut./Interv. | Dates/siècle [type = Date de naissance without Siècle] 2#</lido:earliestDate>
                        <lido:latestDate>#Objets | Aut./Interv. | Dates/Siècle [type = Date de mort without Siècle] 2#</lido:latestDate>
                    </lido:vitalDatesActor>
                </lido:actor>
                <lido:roleActor>
