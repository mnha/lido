...
If an event element of the type "Beginning of existence" is used, one of the subelements, eventActor, eventDate, eventPlace or eventMaterialsTech is mandatory.
...
<lido:event>
    ...
    <lido:eventActor>
        ...
        <lido:actorInRole>
            <lido:actor>
                <lido:actorNameSet>
                    <lido:appellationValue lido:label="firstname">#Aut./Interv. | Prénom 1#</lido:appellationValue>
                    <lido:appellationValue lido:label="lastname">#Aut./Interv. | Nom 1#</lido:appellationValue>
                </lido:nameActorSet>
                <lido:vitalDatesActor>
                    <lido:earliestDate>#Aut./Interv. | Dates/Siècle [type=Date de naissance without Siècle] 1#</lido:earliestDate>
                    <lido:latestDate>#Aut./Interv. | Dates/Siècle | [type=Date de mort without Siècle] 1#</lido:latestDate>
                </lido:vitalDatesActor>
            </lido:actor>
            <lido:roleActor>
    ...
    <lido:eventActor>
        ...
        <lido:actorInRole>
            <lido:actor>
                <lido:nameActorSet>
                    <lido:appellationValue lido:label="firstname">#Objets | Aut./Interv. | Prénom 2#</lido:appellationValue>
                    <lido:appellationValue lido:label="lastname">#Objets | Aut./Interv. | Nom 2#</lido:appellationValue>
                </lido:nameActorSet>
                <lido:vitalDatesActor>
                    <lido:earliestDate>#Aut./Interv. | Dates/Siècle [type=lieu de naissance without Siècle] 2#</lido:earliestDate>
                    <lido:latestDate>#Aut./Interv. | Dates/Siècle [type=lieu de mort without Siècle] 2#</lido:latestDate>
                </lido:vitalDatesActor>
            </lido:actor>
            <lido:roleActor>
                <lido:term>#Objets | Aut./Interv. | Rôle 2 (fr)#</lido:term>
